...
import DocumentList from "./components/DocumentTemplateList"
export default {
    name: 'Document',
    components: {
        DocumentList
    ...
    methods :{
        //打开时加载树信息
        getTreeData(){
            axios.get(`${this.baseURL}/basicdata/documentTemplate.php?flag=getTreeListData`)
            .then((response) => {
        ...
        saveTreeList(event) {            
            ...
            axios.post(`${this.baseURL}/basicdata/documentTemplate.php`,fd)
            .then((response) => {               
                console.log(response)
                if(response.data.state == "success"){
                    this.getTreeData()
        ...
        //树节点模糊查询
        VaguelySelect(){
            axios.get(`${this.baseURL}/basicdata/documentTemplate.php?flag=VaguelySelect&vaguelydata=${this.vaguelydata}`)
            .then((response) => {
                this.treeData = response.data.data;
            })
            .catch(function(error){
