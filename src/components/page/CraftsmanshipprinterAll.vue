        ...
        <div v-for="(cra,carindex) in craftsmanship" :key="carindex">
            ...
            <table class="tableHeader">
                <tr>
                    ...
                    <td>编号</td>
                    <td>{{ cra.craftsmanshipTableHeader.ownPartDrawingNumber + "-" + cra.craftsmanshipTableHeader.contactId  }}</td>
                    <td>工单号：</td>
                </tr>
            </table>
            <table class="tableHeader">
                <tr>
                    <td>产品名称</td>
                    <td>{{ cra.craftsmanshipTableHeader.productName }}</td>
                    <td>所属部件名称</td>
                    <td>{{ cra.craftsmanshipTableHeader.ownPartName }}</td>
                    <td colspan="4">零部件名称</td>
                    <td>{{ cra.craftsmanshipTableHeader.partsName }}</td>
                    <td colspan="4">工件编号</td>
                    <td>{{ cra.craftsmanshipTableHeader.workpieceNumber }}</td>
                </tr>
                <tr>
                    <td>产品图号</td>
                    <td>{{ cra.craftsmanshipTableHeader.productDrawingNumber }}</td>
                    <td>所属部件图号</td>
                    <td>{{ cra.craftsmanshipTableHeader.ownPartDrawingNumber }}</td>
                    <td colspan="4">零部件图号</td>
                    <td>{{ cra.craftsmanshipTableHeader.partsDrawingNumber }}</td>
                    <td colspan="4">数量</td>
                    <td>{{ cra.craftsmanshipTableHeader.quantity }}</td>
                </tr>
            </table>
            <!-- 头部信息 end -->
            <!-- 模板一 start -->
            <table class="tableFirstModel" v-if="cra.model == 1">
                <tr>
                ...
                <tr>
                    <td colspan="4">结论</td>
                    <td colspan="10">{{ cra.craftsmanshipTableBodyResult.conclusion }}</td>
                </tr>
                <tr>
            ...
            <!-- 模板一 end -->
            <!-- 模板二 start -->
            <table class="tableSecondModel" v-if="cra.model == 2">
                <tr>
                ...
                <tr>
                    <td colspan="4">结论</td>
                    <td>{{ cra.craftsmanshipTableBodyResult.conclusion }}</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td colspan="4">不符合确认</td>
                    <td>{{ cra.craftsmanshipTableBodyResult.inconsistentConfirmation }}</td>
                <td>&nbsp;</td>
                </tr>
            ...
            <table class="tableSecondModel" v-if="cra.model == 2">
                <tr>
                    <td colspan="2" ref="secondmodelimgone" id="secondmodelimgone" class="craftsmanshipTableBody_2_img" @drop="drop($event,'1')" @dragover="allowDrop($event)" v-html="`<img  src='${baseURL}/${cra.craftsmanshipTableBody_2.fileOne}' style='max-width:100%;max-height:100%;pointer-events:none;display:${isEmpty(cra.craftsmanshipTableBody_2.fileOne)};' />`">&nbsp;</td>
                    <td colspan="2" ref="secondmodelimgtwo" id="secondmodelimgtwo" class="craftsmanshipTableBody_2_img" @drop="drop($event,'2')" @dragover="allowDrop($event)" v-html="`<img  src='${baseURL}/${cra.craftsmanshipTableBody_2.fileTwo}' style='max-width:100%;max-height:100%;pointer-events:none;display:${isEmpty(cra.craftsmanshipTableBody_2.fileTwo)};' />`">&nbsp;</td>
                    <td colspan="2" ref="secondmodelimgthree" id="secondmodelimgthree" class="craftsmanshipTableBody_2_img" @drop="drop($event,'3')" @dragover="allowDrop($event)" v-html="`<img  src='${baseURL}/${cra.craftsmanshipTableBody_2.fileThree}' style='max-width:100%;max-height:100%;pointer-events:none;display:${isEmpty(cra.craftsmanshipTableBody_2.fileThree)};' />`">&nbsp;</td>
                </tr>
            </table>
            <!-- 模板二 end -->
            <!-- 模板三 start-->
            <table class="tableThirdModel" v-if="cra.model == 3">
                <tr>
                    <td ref="thirdmodelimg" id="thirdmodelimg" @drop="drop($event,'4')" @dragover="allowDrop($event)" v-html="`<img  src='${baseURL}/${cra.craftsmanshipTableBody_3.fileOne}' style='max-width:100%;max-height:100%;pointer-events:none;display:${isEmpty(cra.craftsmanshipTableBody_3.fileOne)};' />`"></td>
                </tr>
            </table>
            <!-- 模板三 end -->
            <!-- 尾部信息 start -->
            <table class="tableFooter">
                <tr>
                    <td>最终结论：</td>
                    <td  style="width: 18%;">{{ cra.craftsmanshipTableFooter.finalConclusion }}</td>
                    <td>检验员：（日期）</td>
                    <td  style="width: 18%;">{{ cra.craftsmanshipTableFooter.inspector }}</td>
                    <td>检验审核：（日期）</td>
                    <td  style="width: 18%;">{{ cra.craftsmanshipTableFooter.inspectionAudit }}</td>
                </tr>
            </table>
            <table class="tableFooter">
                
                <tr>
                    <td>{{ cra.craftsmanshipTableFooter.mark }}</td>
                    <td>{{ cra.craftsmanshipTableFooter.numberOfPlaces }}</td>
                    <td>{{ cra.craftsmanshipTableFooter.changeTheFileNumber }}</td>
                    <td>{{ cra.craftsmanshipTableFooter.signature }}</td>
                    <td>{{ cra.craftsmanshipTableFooter.date }}</td>
                    <td>编制（日期） </td>
                    <td>审核（日期）</td>
                ...
                <tr>
                    ...
                    <td>签名</td>
                    <td>日期</td>
                    <td>{{ cra.craftsmanshipTableFooter.establishment }}</td>
                    <td>{{ cra.craftsmanshipTableFooter.review }}</td>
                </tr>
            </table>
            <!-- 尾部信息 end -->
            <div class="page"></div>
